  ...
  methods: {
    getCountry: function() {
      axios({
        method: "GET",
        url:
          "https://www.cheapfarego.com/api/api.php?getCountries=getCountries",
        headers: {
    ...
    getState: function() {
      axios({
        method: "GET",
        url:
          "https://www.cheapfarego.com/api/api.php?getStates=getStates&country_id=" +
          this.country_id,
        headers: {
          "Content-Type": "application/x-www-form-urlencoded"
        },
    ...
    submitForm: function() {
      ...
      axios({
        method: "POST",
        data: bodyFormData,
        url: "https://www.cheapfarego.com/api/api.php?sendform=sendform",
