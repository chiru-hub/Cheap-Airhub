        ...
        <div class="row">
          ...
          <div class="col s24">
            <div style="display: flex; justify-content: flex-end;margin-top:25px">
              <button class="btn" type="submit" @click="newSearch">Submit</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="form_body" style="padding:30px">
        ...
        <div class="row">
          <div class="col s24">
            ...
            <p style="color:black;font-weight:bold">1888-655-0791 </p>
          </div>
        </div>
      </div>
    </div>
                  ...
                  <div class="flight_data row">
                    ...
                    >
                      ...
                      <div style="display:flex;align-items:center">
                        ...
                        />
                          <p class="flight__phone">1888-655-0791</p>
                      </div>
                      <a
                        class="btn"
                        href="tel:1888-655-0791 "
...
export default {
  ...
  mounted() {
            ...
            $(".telephone").attr("href" , 'tel:1888-655-0791')
    ...
    // }
      ...
      axios({
        method: "GET",
        url: "https://www.cheapfarego.com/api/api.php?getAirport=getAirport&query=" + ori_,
        headers: {
      ...
      axios({
        method: "GET",
        url: "https://www.cheapfarego.com/api/api.php?getAirport=getAirport&query=" + des_,
        headers: {
          "Content-Type": "application/x-www-form-urlencoded"
        }
      })
