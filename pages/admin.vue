  ...
  methods: {
    checkSession: function() {
      axios({
        method: "GET",
        url:
          "https://www..com/api/api.php?checkSession=checkSession&token=" +
    ...
    getData: function() {
      axios({
        method: "GET",
        url: "https://www..com/api/api.php?getData=getData",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded"
        }
      })
    ...
    contactData: function() {
      axios({
        method: "GET",
        url:
          "https://www..com/api/api.php?getDataContact=getDataContact",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded"
        }
      })
    ...
    deleteData: function(e) {
      axios({
        method: "POST",
        url:
          "https://www..com/api/api.php?sendformDelete=sendformDelete&id=" +
          e +
          "&token=" +
          localStorage.getItem("random"),
        headers: {
    ...
    saveDisc: function(e) {
      axios({
        method: "POST",
        url:
          "https://www..com/api/api.php?saveDisc=saveDisc&id=" +
    ...
    sendDisc: function(e) {
      axios({
        method: "GET",
        url:
          "https://www..com/api/api.php?sendDisc=sendDisc",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded"
        }
      })
    ...
    deleteData1: function(e) {
      axios({
        method: "POST",
        url:
          "https://www..com/api/api.php?contactDelete=contactDelete&id=" +
          e +
          "&token=" +
          localStorage.getItem("random"),
        headers: {
