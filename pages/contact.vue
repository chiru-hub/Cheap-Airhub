        ...
        <div class="text-detailpage xs-padd-0">
          ...
          <div class="row body-contact">
            <!-- <div class="detail-info col l12 m24 m24">
              ...
              >CheapFareGo subsidiary Of Fx Trade Consulting Private Limited</h4>
              ...
              <p><span style="font-weight:bold">Email : </span>support@cheapfarego.com</p>
              <p><span style="font-weight:bold">Customer Service Number</span> <span>Toll Free :</span> +1-888-201-0212</p>
              <p
                v-if="form_submitted"
                style="color:green"
  ...
  methods: {
    ...
    sendContact: function() {
      ...
      axios({
        ...
        data: bodyFormData,
        url:
          "https://www.cheapfarego.com/api/api.php?sendformContact=sendformContact",
