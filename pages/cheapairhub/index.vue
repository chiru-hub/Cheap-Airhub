<template>
  <div>
    ...
    <div style="text-align:center">
      <p style="color:white;font-size:45px">1888-201-0212</p>
  ...
  methods: {
    ...
    submit: function() {
      ...
      if (this.source == "amadeus") {
        ...
        // this.$router.push("/cheapfarego/cheapflightresults");
      ...
      var rtn = 'one-way'
        if(this.picked == 'roundtrip'){
          ...
          window.location.href = "/cheapfarego/flights/find-result/?origin=" + $("#from_iata").val().toLowerCase()  + "&destination=" + $("#to_iata").val().toLowerCase() + "&adult=" + $(".drop-down1 .selected .value").html() + "&child=" + $(".drop-down2 .selected .value").html() + "&infant_on_seat=" + $(".drop-down3 .selected .value").html() + "&triptype=" + rtn + "&departure="+ $("#dep_date_hidden").val()  +"&return="+ $("#ret_date_hidden").val() +"&cabin=" + $(".drop-down .selected .value").html().toLowerCase() + "&utm_source=skyscanner"
          ...
          window.location.href = "/cheapfarego/flights/find-result/?origin=" + $("#from_iata").val().toLowerCase()  + "&destination=" + $("#to_iata").val().toLowerCase() + "&adult=" + $(".drop-down1 .selected .value").html() + "&child=" + $(".drop-down2 .selected .value").html() + "&infant_on_seat=" + $(".drop-down3 .selected .value").html() + "&triptype=" + rtn + "&departure="+ $("#dep_date_hidden").val()  + "&cabin=" + $(".drop-down .selected .value").html().toLowerCase() + "&utm_source=skyscanner"
...
// https://www.cheapfarego.com/flights/find-result/?origin=sin&destination=syd&adult=1&child=0&infant_on_seat=1&triptype=return&departure=2019-10-25&return=2019-11-01&cabin=economy&utm_source=1026
       
       
       
      //  this.$router.push("/cheapfarego/flights/" + $("#from_iata").val().toLowerCase()  + "/" + $("#to_iata").val().toLowerCase() + "/" + newstring1 + "/" + newstring2 + "/?adults=" + $(".drop-down1 .selected .value").html() + "&children=" + $(".drop-down2 .selected .value").html() + "&infants=" + $(".drop-down3 .selected .value").html() + "&cabinclass=" + $(".drop-down .selected .value").html() + "&rtn=" + rtn + "&utm_campaign=skyscanner" );
      }
